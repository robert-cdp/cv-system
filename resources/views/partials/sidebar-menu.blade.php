<ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="navigation"
    ...
    <x-menu.group icon="fas fa-concierge-bell" label="Servicios" active-route="services.*">
        <x-menu.item route="services.categories.index" icon="far fa-folder" label="Administrar Categorías" />
        <x-menu.item route="services.categories.create" icon="fas fa-folder-plus" label="Nueva Categoría" />
    ...
    <x-menu.group icon="fas fa-user-friends" label="Usuarios" active-route="user.*">
        <x-menu.item route="user.index" icon="fas fa-users" label="Administrar Usuarios" />
        <x-menu.item route="user.create" icon="fas fa-user-plus" label="Nuevo Usuario" />
    </x-menu.group>

    <x-menu.group icon="fas fa-user-friends" label="Usuarios" active-route="roles.*">
        <x-menu.item route="user.index" icon="fas fa-users" label="Administrar Usuarios" />
        <x-menu.item route="user.create" icon="fas fa-user-plus" label="Nuevo Usuario" />
    </x-menu.group>
</ul>
